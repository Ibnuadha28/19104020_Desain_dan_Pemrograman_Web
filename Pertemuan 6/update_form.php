...
// Menampilkan seluruh data
    ...
    $data_crud = $conn->query($sql);

    $sql_mahasiswa = "SELECT * FROM data_crud WHERE id=".$_GET['mahasiswa_id']; 
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 mb-5">
                ...
                <!-- Menyimpan data ke dalam simpan.php -->
            ...
            <div class="col-lg-6">
                ...
                <!-- Menampilkan data yang ada pada mysql -->
                <?php foreach($data_crud as $dt) : ?>               
                <div class="card mb-2">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <img src="/gambar/<?php echo $dt['foto'] ?>" alt="" width="100%">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                href="hapus_data.php?mahasiswa_id=<?php echo $dt['id'] ?>"
                                type="button" class="close">
                                    <span class="fa fa-trash"></span>
                                </a>
                                <a class="float-right ml-3 text_success" 
                                href="update_from.php?mahasiswa_id=<?php echo $dt['id'] ?>"
                                type="button" class="close">
